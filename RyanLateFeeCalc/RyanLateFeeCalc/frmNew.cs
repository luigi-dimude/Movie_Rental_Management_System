...
namespace RyanLateFeeCalc
{
    public partial class frmNew : Form
    {
        ...
        {
            this.Hide(); // Hides the New Releases form to navigate back to Menu
        }
        ...
        {
            // Calculate the late fee per movie for New releases by subtracting 2 dollars for each day the user is late 
