...
namespace RyanLateFeeCalc
{
    public partial class frmKids : Form
    {
        ...
        {
            // Calculate the late fee for Kid Movies by subtracting 0.15 dollars for each day the user is late 
        ...
        {
            this.Hide(); // Hides the Kids Moives form to navigate back to Menu
        }
